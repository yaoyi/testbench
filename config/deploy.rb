...
set :puma_bind, %w(unix:///u/apps/intercity_sample_app/current/tmp/sockets/puma0.sock unix:///u/apps/intercity_sample_app/current/tmp/sockets/puma1.sock unix:///u/apps/intercity_sample_app/current/tmp/sockets/puma2.sock)
