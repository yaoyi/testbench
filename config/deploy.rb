...
set :puma_bind, %w(unix://#{current_path}/tmp/sockets/puma0.sock unix://#{current_path}/tmp/sockets/puma1.sock unix://#{current_path}/tmp/sockets/puma2.sock)    #accept array for multi-bind
